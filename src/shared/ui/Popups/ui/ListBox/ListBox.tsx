...
export const ListBox = memo(({
    ...
    return (
        <HStack gap="4">
            ...
            <HListBox
                as="div"
                className={classNames(cls.ListBoxContainer, {}, [className, popupCls.popup])}
                value={value}
                onChange={onChange}
                disabled={readonly}
            >
                ...
                <HListBox.Options className={classNames(cls.options, { [popupCls.disabled]: readonly }, optionsAdditionalClasses)}>
