...
describe('features/EditableProfileCard', () => {
    ...
    test('if user press cancel in edit mode it should become view mode', async () => {
        ...
        await userEvent.type(
            screen.getByTestId('ProfileCard.SurnameInput'),
            'user',
        );
        ...
        expect(screen.getByTestId('ProfileCard.SurnameInput')).toHaveValue(
    ...
    test('if in edit mode entered values in all fields is correct client should send correct PUT request', async () => {
