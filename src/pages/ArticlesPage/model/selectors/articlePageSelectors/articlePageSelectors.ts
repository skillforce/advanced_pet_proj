...
export const getArticlePageView = (state: StateSchema) =>
    state.articlesPage?.view || ArticlesView.SMALL;
...
export const getArticlePageSearchText = (state: StateSchema) =>
    state.articlesPage?.searchText || '';
export const getArticlePageFiltersType = (state: StateSchema) =>
    state.articlesPage?.type ?? ArticlesType.ALL;
